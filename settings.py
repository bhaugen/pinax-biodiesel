# -*- coding: utf-8 -*-
# Django settings for pinax-biodiesel project.
...
STATICFILES_DIRS = (
    ('pinax-biodiesel', os.path.join(PROJECT_ROOT, 'media')),
...
ROOT_URLCONF = 'pinax-biodiesel.urls'
...
MARKUP_FILTER_FALLBACK = 'markdown'
MARKUP_CHOICES = (
